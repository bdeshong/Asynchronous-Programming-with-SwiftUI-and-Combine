...
class SignUpFormViewModel: ObservableObject {
    ...
    init() {
        ...
        Publishers.CombineLatest3(isPasswordEmptyPublisher, isPasswordMatchingPublisher, passwordStrengthPublisher)
            .map{isPasswordEmpty, isPasswordMatching, passwordStrength in
                if isPasswordEmpty {
